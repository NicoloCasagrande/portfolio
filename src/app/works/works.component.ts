...
export class WorksComponent implements OnInit{
  ...
  ngOnInit(){
    this.works.push(new Work('Internal Chat Reproduction', 'Creation of an Enterprise chat for employee only', 'https://nicolocasagrande.github.io/chat-reactjs/', 'https://github.com/NicoloCasagrande/chat-reactjs'));
